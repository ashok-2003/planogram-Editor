...
import { Sku, Refrigerator, LayoutData, DoorConfig } from './types'; // Updated types
...
// --- REFACTORED: All layouts now use the 'doors' array structure ---
...
// --- FIXED: This now points to the full LayoutData object ---
export const initialLayout: LayoutData = availableLayoutsData['g-26c'];
...
// --- FIXED: This now returns the full LayoutData object ---
export const getInitialLayout = async (): Promise<LayoutData> => {
